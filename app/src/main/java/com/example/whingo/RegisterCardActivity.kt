...
import com.example.whingo.databinding.ActivityRegisterCardBinding
...
class RegisterCardActivity : AppCompatActivity() {
        ...
        binding.btnRegisterCard.setOnClickListener {
            if (userId != null) {
                if (cardValidation()){
                    ...
                    Log.w(ContentValues.TAG, "Cartão cadastrado com sucesso")
    ...
    private fun saveCardToFirestore(
        ...
        Log.d(ContentValues.TAG, "Cartão: $card")
        db.collection("pessoas")
            .document(uId).collection("cartoes")
            .add(card)
            .addOnSuccessListener { documentReference ->
                Log.d(ContentValues.TAG, "Cartao adicionado com Id: ${documentReference.id}")
            }
